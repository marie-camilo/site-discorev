...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-right">
            <img src="assets/img/accueil.png" alt="Illustration d'un bureau moderne" width="600" height="400" loading="lazy">
        </div>
    </section>
    ...
    <section class="explore-companies">
        ...
        <div class="company-grid">
            ...
            <div class="company-card">
                ...
                <a class="cta-link" href="pages/petit-fils.php">+32 offres</a>
            </div>
            ...
            <div class="company-card">
                ...
                <p>Rejoignez une entreprise qui partage vos valeurs.</p>
                <a class="cta-link" href="pages/senior-compagnie.php">+142 offres</a>
            </div>
